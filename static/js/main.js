...
//  var dataListIds = ['list1', 'list2', 'list3', 'list4', 'list5'];
//  for (var i=0; i<dataListIds.length; i++) {
//    var dataList = document.getElementById(dataListIds[i]);
//    var options = dataList.options;
//    console.log('Values for datalist ' + (i+1) + ':');
